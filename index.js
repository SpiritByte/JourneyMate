...
client.on('interactionCreate', async (interaction) => {
  ...
  if (interaction.commandName === 'search') {
    ...
    const response = await axios.post(
      ...
      {
        headers: {
          Authorization: `Bearer ${'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'}`,
...
client.on('ready', async () => {
  const apiKey = 'acc_3b529c3ec3e9240';
  const apiSecret = 'ed77f11a7cd9929db6d4d378952ef856';
  const guildId = '1093941116816072796';
  const clientId = '1093946946764419293';
  const clientSecret = 'g55iGciQHqi5_IrjX-ltoPqqoeYIr12b';
  const botToken = 'MTA5Mzk0Njk0Njc2NDQxOTI5Mw.GUWq4p.g9DFON9kLSBAxbLJ79Ol9FkSpuGWr6bJ_HhTqw';
  const apiToken = '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';
...
client.login("MTA5Mzk0Njk0Njc2NDQxOTI5Mw.GUWq4p.g9DFON9kLSBAxbLJ79Ol9FkSpuGWr6bJ_HhTqw");
